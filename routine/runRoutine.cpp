...
Thread routineManagerThread(osPriorityNormal, OS_STACK_SIZE, nullptr, "Routine Manger");

//Create Routine Thread
Thread routineThread(osPriorityRealtime, OS_STACK_SIZE, nullptr, "Routine Runner");
