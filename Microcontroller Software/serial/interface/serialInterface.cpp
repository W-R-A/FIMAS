...
//Create a serial interface with settings defined in hardware.hpp
//Serial default setttings - int bits=8, Parity parity=SerialBase::None, int stop_bits=1
UnbufferedSerial pc(USART_TX, USART_RX, 115200);
...
//Use standard namespace to keep things cleaner when working with strings
using namespace std;
...
{
    //Based on work by Sam Duffield - MDAS and examples on the mbed website, https://os.mbed.com/docs/mbed-os/v5.15/apis/mail.html
...
//Inspired from work by Dr. Paul Davey - ELEC 240 - Using USART with STM32 Microcontrollers
